...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("精灵训练师") },
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("精灵训练师") },
    [TRAINER_CLASS_HIKER] = { _("登山男"), 10 },
    [TRAINER_CLASS_TEAM_AQUA] = { _("水舰队") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("精灵饲育家"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("精英训练师"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("驯鸟师"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("精灵收集家"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("泳裤男"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("火岩队") },
    [TRAINER_CLASS_EXPERT] = { _("高手"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("水舰队干部"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("空手道达人"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("水舰队首领"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("灵异迷"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("香气大姐"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("遗迹狂"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("采访记者"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("泳圈儿童"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("泳圈儿童"), 1 },
    [TRAINER_CLASS_LADY] = { _("大小姐"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("成熟大姐"), 20 },
    [TRAINER_CLASS_RICH_BOY] = { _("大少爷"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("精灵狂热者"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("吉他手"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("火把男"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("露营少年"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("郊游少女"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("昆虫迷"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("超能力者"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("绅士"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("四天王"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("馆主"), 25 },
    [TRAINER_CLASS_SCHOOL_KID] = { _("小学生") },
    [TRAINER_CLASS_SR_AND_JR] = { _("学姐和学妹"), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("连胜之家"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("超喜欢俱乐部"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("短裤小子"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("联盟冠军"), 50 },
    [TRAINER_CLASS_FISHERMAN] = { _("钓鱼者"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("铁人三项者"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("龙之使者"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("忍者儿童"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("战斗少女"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("阳伞大姐"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("比基尼大姐"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("双胞胎"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("水手"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("精英训练师"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("火岩队干部"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("精灵训练师"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("捕虫少年"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("精灵护林员"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("火岩队首领"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("少女"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("甜蜜恋人"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("金婚夫妇"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("姐弟二人组"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("对战大君") },
    ...
    [TRAINER_CLASS_RS_PROTAG] = { _("精灵训练师") },
};
