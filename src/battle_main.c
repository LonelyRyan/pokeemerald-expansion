...
{
    TRAINER_CLASS(PKMN_TRAINER_1, "精灵训练师"),
    TRAINER_CLASS(PKMN_TRAINER_2, "精灵训练师"),
    TRAINER_CLASS(HIKER, "登山男", 10),
    TRAINER_CLASS(TEAM_AQUA, "水舰队"),
    TRAINER_CLASS(PKMN_BREEDER, "精灵饲育家", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_HEAL_BALL : ITEM_FRIEND_BALL),
    TRAINER_CLASS(COOLTRAINER, "精英训练师", 12, ITEM_ULTRA_BALL),
    TRAINER_CLASS(BIRD_KEEPER, "驯鸟师", 8),
    TRAINER_CLASS(COLLECTOR, "精灵收集家", 15, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "泳裤男", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "火岩队"),
    TRAINER_CLASS(EXPERT, "高手", 10),
    TRAINER_CLASS(AQUA_ADMIN, "水舰队干部", 10),
    TRAINER_CLASS(BLACK_BELT, "空手道达人", 8, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "水舰队首领", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(HEX_MANIAC, "灵异迷", 6),
    TRAINER_CLASS(AROMA_LADY, "香气大姐", 10),
    TRAINER_CLASS(RUIN_MANIAC, "遗迹狂", 15),
    TRAINER_CLASS(INTERVIEWER, "采访记者", 12),
    TRAINER_CLASS(TUBER_F, "泳圈儿童", 1),
    TRAINER_CLASS(TUBER_M, "泳圈儿童", 1),
    TRAINER_CLASS(LADY, "大小姐", 50),
    TRAINER_CLASS(BEAUTY, "成熟大姐", 20),
    TRAINER_CLASS(RICH_BOY, "大少爷", 50),
    TRAINER_CLASS(POKEMANIAC, "精灵狂热者", 15),
    TRAINER_CLASS(GUITARIST, "吉他手", 8),
    TRAINER_CLASS(KINDLER, "火把男", 8),
    TRAINER_CLASS(CAMPER, "露营少年", 4),
    TRAINER_CLASS(PICNICKER, "郊游少女", 4),
    TRAINER_CLASS(BUG_MANIAC, "昆虫迷", 15),
    TRAINER_CLASS(PSYCHIC, "超能力者", 6),
    TRAINER_CLASS(GENTLEMAN, "绅士", 20, ITEM_LUXURY_BALL),
    TRAINER_CLASS(ELITE_FOUR, "四天王", 25, ITEM_ULTRA_BALL),
    TRAINER_CLASS(LEADER, "馆主", 25),
    TRAINER_CLASS(SCHOOL_KID, "小学生"),
    TRAINER_CLASS(SR_AND_JR, "学姐和学妹", 4),
    TRAINER_CLASS(WINSTRATE, "连胜之家", 10),
    TRAINER_CLASS(POKEFAN, "超喜欢俱乐部", 20),
    TRAINER_CLASS(YOUNGSTER, "短裤小子", 4),
    TRAINER_CLASS(CHAMPION, "联盟冠军", 50),
    TRAINER_CLASS(FISHERMAN, "钓鱼者", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_BALL : ITEM_LURE_BALL),
    TRAINER_CLASS(TRIATHLETE, "铁人三项者", 10),
    TRAINER_CLASS(DRAGON_TAMER, "龙之使者", 12),
    TRAINER_CLASS(NINJA_BOY, "忍者儿童", 3),
    TRAINER_CLASS(BATTLE_GIRL, "战斗少女", 6),
    TRAINER_CLASS(PARASOL_LADY, "阳伞大姐", 10),
    TRAINER_CLASS(SWIMMER_F, "比基尼大姐", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "双胞胎", 3),
    TRAINER_CLASS(SAILOR, "水手", 8),
    TRAINER_CLASS(COOLTRAINER_2, "精英训练师", 5, ITEM_ULTRA_BALL),
    TRAINER_CLASS(MAGMA_ADMIN, "火岩队干部", 10),
    TRAINER_CLASS(RIVAL, "精灵训练师", 15),
    TRAINER_CLASS(BUG_CATCHER, "捕虫少年", 4),
    TRAINER_CLASS(PKMN_RANGER, "精灵护林员", 12),
    TRAINER_CLASS(MAGMA_LEADER, "火岩队首领", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(LASS, "少女", 4),
    TRAINER_CLASS(YOUNG_COUPLE, "甜蜜恋人", 8),
    TRAINER_CLASS(OLD_COUPLE, "金婚夫妇", 10),
    TRAINER_CLASS(SIS_AND_BRO, "姐弟二人组", 3),
    TRAINER_CLASS(SALON_MAIDEN, "对战大君"),
    TRAINER_CLASS(DOME_ACE, "巨蛋超级巨星"),
    TRAINER_CLASS(PALACE_MAVEN, "宫殿守护者"),
    TRAINER_CLASS(ARENA_TYCOON, "竞技场主将"),
    TRAINER_CLASS(FACTORY_HEAD, "工厂头目"),
    TRAINER_CLASS(PIKE_QUEEN, "水管皇后"),
    TRAINER_CLASS(PYRAMID_KING, "金字塔法老"),
    TRAINER_CLASS(RS_PROTAG, "精灵训练师"),
};
