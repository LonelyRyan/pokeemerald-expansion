...
static const u8 sText_Lanettes[] = _("真弓的"); //no decapitalize until it is everywhere
...
static const u8 sText_TwoInGameTrainersDefeated[] = _("战胜了{B_TRAINER1_NAME_WITH_CLASS} 和\n{B_TRAINER2_NAME_WITH_CLASS}！\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_AVOIDEDDAMAGE]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}依靠{B_DEF_ABILITY}避开了伤害！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNMADESLEEP]                        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_BUFF1}让\n{B_EFF_NAME_WITH_PREFIX2}睡着了！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNWASNTAFFECTED]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n没有受到影响。"), //not in gen 5+, ability popup
    [STRINGID_PKMNWASPOISONED]                      = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\n中毒了！"),
    [STRINGID_PKMNPOISONEDBY]                       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}因\n{B_SCR_NAME_WITH_PREFIX2}的{B_BUFF1}中毒了！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNBADLYPOISONED]                    = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\n中剧毒了！"),
    [STRINGID_PKMNENERGYDRAINED]                    = COMPOUND_STRING("从{B_DEF_NAME_WITH_PREFIX}那里\n吸取了体力！"),
    [STRINGID_PKMNWASBURNED]                        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\n被灼伤了！"),
    [STRINGID_PKMNBURNEDBY]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_BUFF1}让{B_EFF_NAME_WITH_PREFIX2}灼伤了！"), //not in gen 5+, ability popup
    [STRINGID_PKMNHURTBYBURN]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n受到了灼伤的伤害！"),
    [STRINGID_PKMNWASFROZEN]                        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\n被冻住了！"),
    [STRINGID_PKMNFROZENBY]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_BUFF1}让{B_EFF_NAME_WITH_PREFIX2}冻住了！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_BUFF1}\n使{B_EFF_NAME_WITH_PREFIX2}麻痹了,\n很难使出招式！"), //not in gen 5+, ability popup
    ...
    [STRINGID_TEAMSTOPPEDWORKING]                   = COMPOUND_STRING("我方的{B_BUFF1}失效了！"), //unused
    [STRINGID_FOESTOPPEDWORKING]                    = COMPOUND_STRING("对方的{B_BUFF1}失效了！"), //unused
    ...
    [STRINGID_PKMNFLINCHED]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n畏缩了，无法使出招式！"),
    [STRINGID_PKMNREGAINEDHEALTH]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的体力回复了。"),
    ...
    [STRINGID_PKMNCLAMPED]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n被{B_DEF_NAME_WITH_PREFIX2}的贝壳夹住了！"),
    ...
    [STRINGID_PKMNSTAYEDAWAKEUSING]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}利用其\n{B_DEF_ABILITY}保持清醒！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PLAYERPICKEDUPMONEY]                  = COMPOUND_STRING("捡到了¥{B_BUFF1}！\p"),
    ...
    [STRINGID_PKMNREDUCEDPP]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\nPP减少了！"),
    [STRINGID_PKMNSTOLEITEM]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}从{B_DEF_NAME_WITH_PREFIX2}那里\n夺取了{B_LAST_ITEM}！"),
    ...
    [STRINGID_PKMNIDENTIFIED]                       = COMPOUND_STRING("识破了\n{B_DEF_NAME_WITH_PREFIX}的原形！"),
    ...
    [STRINGID_PKMNGOTFREE]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}从\n{B_DEF_NAME_WITH_PREFIX2}的{B_BUFF1}中解脱了！"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNSHEDLEECHSEED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}摆脱了\n寄生种子！"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNBLEWAWAYSPIKES]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}吹掉了\n撒菱！"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_NATUREPOWERTURNEDINTO]                = COMPOUND_STRING("自然之力\n变成了{B_CURRENT_MOVE}!"),
    ...
    [STRINGID_PKMNCANTUSEMOVETAUNT]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了挑衅，\n无法使出{B_CURRENT_MOVE}！\p"),
    ...
    [STRINGID_PKMNMADEWISH]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}进行了祈愿！"), //unused
    ...
    [STRINGID_PKMNWASMADEDROWSY]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n产生睡意了！"),
    ...
    [STRINGID_PKMNMOVEBOUNCED]                      = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\n将{B_CURRENT_MOVE}反射了回去！"),
    ...
    [STRINGID_PKMNMADEITRAIN]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_SCR_ACTIVE_ABILITY}使天气变成了雨天！"), //not in gen 5+, ability popup
    [STRINGID_PKMNRAISEDSPEED]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_SCR_ACTIVE_ABILITY}使速度提高了！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPROTECTEDBY]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n收到了{B_DEF_ABILITY}的保护！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSUSAGE]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n阻止了{B_ATK_NAME_WITH_PREFIX2}使用{B_CURRENT_MOVE}！"), //I don't see this in SV text
    [STRINGID_PKMNRESTOREDHPUSING]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n利用其{B_DEF_ABILITY}回复了HP！"), //not in gen 5+, ability popup
    [STRINGID_PKMNCHANGEDTYPEWITH]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}使其变成了{B_BUFF1}属性！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSPARALYSISWITH]            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}防止了麻痹！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSROMANCEWITH]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}防止了着迷！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSPOISONINGWITH]            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}防止了中毒！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSCONFUSIONWITH]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}防止了混乱！"), //not in gen 5+, ability popup
    [STRINGID_PKMNRAISEDFIREPOWERWITH]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}提高了火属性招式的威力！"), //not in gen 5+, ability popup
    [STRINGID_PKMNANCHORSITSELFWITH]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_DEF_ABILITY}使自己扎下了根！"), //not in gen 5+, ability popup
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_SCR_ACTIVE_ABILITY}削减了{B_DEF_NAME_WITH_PREFIX2}的攻击！"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSSTATLOSSWITH]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_SCR_ACTIVE_ABILITY}防止了能力下降！"), //not in gen 5+, ability popup
    [STRINGID_PKMNHURTSWITH]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n因{B_DEF_NAME_WITH_PREFIX2}的{B_BUFF1}而受到了伤害！"),
    ...
    [STRINGID_123POOF]                              = COMPOUND_STRING("1…{PAUSE 10}2…{PAUSE 10}然后…{PAUSE 10}{PAUSE 20}{PLAY_SE SE_BALL_BOUNCE_1}空！\p"),
    [STRINGID_ANDELLIPSIS]                          = COMPOUND_STRING("然后…\p"),
    [STRINGID_NOTVERYEFFECTIVE]                     = COMPOUND_STRING("效果不好…"),
    ...
    [STRINGID_MIRRORMOVEFAILED]                     = COMPOUND_STRING("镜像招式失败了！"), //not in gen 5+, uses "but it failed"
    ...
    [STRINGID_RAINCONTINUES]                        = COMPOUND_STRING("雨持续在下。"), //not in gen 5+
    [STRINGID_DOWNPOURCONTINUES]                    = COMPOUND_STRING("大雨仍在持续。"), // unused
    [STRINGID_RAINSTOPPED]                          = COMPOUND_STRING("雨停了。"),
    [STRINGID_SANDSTORMBREWED]                      = COMPOUND_STRING("开始刮沙暴了！"),
    [STRINGID_SANDSTORMRAGES]                       = COMPOUND_STRING("现在正在刮沙暴。"),
    [STRINGID_SANDSTORMSUBSIDED]                    = COMPOUND_STRING("沙暴停止了。"),
    [STRINGID_SUNLIGHTGOTBRIGHT]                    = COMPOUND_STRING("日照变强了！"),
    [STRINGID_SUNLIGHTSTRONG]                       = COMPOUND_STRING("日照非常强烈。"), //not in gen 5+
    [STRINGID_SUNLIGHTFADED]                        = COMPOUND_STRING("日照复原了。"),
    [STRINGID_STARTEDHAIL]                          = COMPOUND_STRING("开始下冰雹了！"),
    [STRINGID_HAILCONTINUES]                        = COMPOUND_STRING("冰雹持续在下。"),
    [STRINGID_HAILSTOPPED]                          = COMPOUND_STRING("冰雹停止了。"),
    [STRINGID_FAILEDTOSPITUP]                       = COMPOUND_STRING("但它没有喷出任何东西！"), //not in gen 5+, uses "but it failed"
    [STRINGID_FAILEDTOSWALLOW]                      = COMPOUND_STRING("但它没有吞下任何东西！"), //not in gen 5+, uses "but it failed"
    ...
    [STRINGID_TOOWEAKFORSUBSTITUTE]                 = COMPOUND_STRING("但是，HP已经不够\n放出替身了！"),
    ...
    [STRINGID_PLAYERUSEDITEM]                       = COMPOUND_STRING("使用了{B_LAST_ITEM}！"),
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("小光使用了{B_LAST_ITEM}！"), //no decapitalize until it is everywhere
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("球被训练家击飞了！"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("不要做个小偷！"),
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("它躲开了精灵球！这只宝可梦无法被收服！"),
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("太好了！\n捉到{B_DEF_NAME}了！{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("太好了！\n{B_DEF_NAME}了！{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}"),
    [STRINGID_GIVENICKNAMECAPTURED]                 = COMPOUND_STRING("要给{B_DEF_NAME}\n起昵称吗？"),
    [STRINGID_PKMNSENTTOPC]                         = COMPOUND_STRING("已将{B_DEF_NAME}\n传送到{B_PC_CREATOR_NAME}的电脑里！"), //Still used lanette's pc since terminology is different
    ...
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("没能逃掉！\p"),
    [STRINGID_PKMNIGNORESASLEEP]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}仍在睡觉，\n没有遵从指令！"),
    [STRINGID_PKMNIGNOREDORDERS]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}没有遵从指令！"),
    [STRINGID_PKMNBEGANTONAP]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}开始打盹了！"),
    [STRINGID_PKMNLOAFING]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n正在偷懒。"),
    ...
    [STRINGID_CREPTCLOSER]                          = COMPOUND_STRING("{B_PLAYER_NAME}悄悄靠近了{B_OPPONENT_MON1_NAME}！"), //safari
    [STRINGID_CANTGETCLOSER]                        = COMPOUND_STRING("{B_PLAYER_NAME}不能再靠近了！"), //safari
    [STRINGID_PKMNWATCHINGCAREFULLY]                = COMPOUND_STRING("{B_OPPONENT_MON1_NAME}正在仔细观察！"), //safari
    [STRINGID_PKMNCURIOUSABOUTX]                    = COMPOUND_STRING("{B_OPPONENT_MON1_NAME}对{B_BUFF1}感到好奇！"), //safari
    [STRINGID_PKMNENTHRALLEDBYX]                    = COMPOUND_STRING("{B_OPPONENT_MON1_NAME}被{B_BUFF1}深深吸引！"), //safari
    [STRINGID_PKMNIGNOREDX]                         = COMPOUND_STRING("{B_OPPONENT_MON1_NAME}完全忽视了{B_BUFF1}！"), //safari
    [STRINGID_THREWPOKEBLOCKATPKMN]                 = COMPOUND_STRING("{B_PLAYER_NAME}向{B_OPPONENT_MON1_NAME}投掷了1个{POKEBLOCK}！"), //safari
    [STRINGID_OUTOFSAFARIBALLS]                     = COMPOUND_STRING("{PLAY_SE SE_DING_DONG}广播员：你没有更多的狩猎球了！游戏结束！\p"), //safari
    [STRINGID_PKMNSITEMCUREDPARALYSIS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了麻痹！"),
    [STRINGID_PKMNSITEMCUREDPOISON]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了中毒！"),
    [STRINGID_PKMNSITEMHEALEDBURN]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了灼伤！"),
    [STRINGID_PKMNSITEMDEFROSTEDIT]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了冰冻状态！"),
    [STRINGID_PKMNSITEMWOKEIT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n让自己醒过来了！"),
    [STRINGID_PKMNSITEMSNAPPEDOUT]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了混乱！"),
    [STRINGID_PKMNSITEMCUREDPROBLEM]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了{B_BUFF1}"),
    [STRINGID_PKMNSITEMRESTOREDHEALTH]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n回复了体力！"),
    [STRINGID_PKMNSITEMRESTOREDPP]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n回复了{B_BUFF1}的PP！"),
    [STRINGID_PKMNSITEMRESTOREDSTATUS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n复原了能力！"),
    [STRINGID_PKMNSITEMRESTOREDHPALITTLE]           = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n回复了少许HP"),
    ...
    [STRINGID_PKMNSXPREVENTSBURNS]                  = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}的{B_EFF_ABILITY}防止了烧伤！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXBLOCKSY]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}阻挡了{B_CURRENT_MOVE}！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXRESTOREDHPALITTLE2]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}回复了少许得HP！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXWHIPPEDUPSANDSTORM]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}扬起了沙暴！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXPREVENTSYLOSS]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}防止了{B_BUFF1}下降！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXINFATUATEDY]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}让{B_ATK_NAME_WITH_PREFIX2}变得着迷了！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXMADEYINEFFECTIVE]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}让{B_CURRENT_MOVE}无效了！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXCUREDYPROBLEM]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}治愈了{B_BUFF1}！"), //not in gen 5+, ability popup
    ...
    [STRINGID_HMMOVESCANTBEFORGOTTEN]               = COMPOUND_STRING("HM技能现在不能被忘记。\p"),
    ...
    [STRINGID_FORXCOMMAYZ]                          = COMPOUND_STRING("对于{B_SCR_NAME_WITH_PREFIX2}, {B_LAST_ITEM} {B_BUFF1}"), //not in gen 5+, expansion doesn't use anymore
    [STRINGID_USINGITEMSTATOFPKMNROSE]              = COMPOUND_STRING("通过{B_LAST_ITEM}，{B_SCR_NAME_WITH_PREFIX2}的{B_BUFF1}{B_BUFF2}"), //todo: update this, will require code changes
    [STRINGID_PKMNUSEDXTOGETPUMPED]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}\n使用了{B_LAST_ITEM}拿出了干劲！"),
    [STRINGID_PKMNSXMADEYUSELESS]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n使{B_CURRENT_MOVE}变得无效了!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXINTENSIFIEDSUN]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}使阳光变强了！"), //not in gen 5+, ability popup
    [STRINGID_PKMNMAKESGROUNDMISS]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}利用{B_DEF_ABILITY}使地面属性招式无效！"), //not in gen 5+, ability popup
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("现在要扔出精灵球了是吧？\n我…我会全力以赴的！"),
    [STRINGID_PKMNSXTOOKATTACK]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n吸引了攻击！"), //In gen 5+ but without naming the ability
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("使用下只宝可梦？"),
    ...
    [STRINGID_PREVENTEDFROMWORKING]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n阻止了{B_SCR_NAME_WITH_PREFIX2}的{B_BUFF1}生效！"), //unused
    [STRINGID_PKMNSITEMNORMALIZEDSTATUS]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n使其状态恢复了！"),
    ...
    [STRINGID_PKMNSXPREVENTSFLINCHING]              = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}的{B_EFF_ABILITY}\n防止了畏缩！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXBLOCKSY2]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n阻挡了{B_CURRENT_MOVE}！"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXWOREOFF]                        = COMPOUND_STRING("{B_ATK_TEAM1}的{B_BUFF1}消失了！"),
    [STRINGID_PKMNRAISEDDEFALITTLE]                 = COMPOUND_STRING("{B_ATK_PREFIX1}的{B_CURRENT_MOVE}\n稍微提高了防御！"), //expansion doesn't use anymore
    [STRINGID_PKMNRAISEDSPDEFALITTLE]               = COMPOUND_STRING("{B_ATK_PREFIX1}的{B_CURRENT_MOVE}\n稍微提高了特防！"), //expansion doesn't use anymore
    [STRINGID_THEWALLSHATTERED]                     = COMPOUND_STRING("墙壁破碎了！"), //not in gen5+, uses "your teams light screen wore off!" etc instead
    [STRINGID_PKMNSXPREVENTSYSZ]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}\n阻止了{B_DEF_NAME_WITH_PREFIX2}的{B_DEF_ABILITY}生效！"),
    [STRINGID_PKMNSXCUREDITSYPROBLEM]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n治愈了自身的{B_BUFF1}！"), //not in gen 5+, ability popup
    [STRINGID_ATTACKERCANTESCAPE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}无法逃走！"),
    ...
    [STRINGID_PKMNINCAPABLEOFPOWER]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}似乎无法使出力量！"),
    [STRINGID_GLINTAPPEARSINEYE]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX2}的眼中闪烁着光芒！"),
    [STRINGID_PKMNGETTINGINTOPOSITION]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}正在就位！"),
    [STRINGID_PKMNBEGANGROWLINGDEEPLY]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}开始发出低沉的咆哮！"),
    [STRINGID_PKMNEAGERFORMORE]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}开始渴望更多！"),
    [STRINGID_DEFEATEDOPPONENTBYREFEREE]            = COMPOUND_STRING("{B_PLAYER_MON1_NAME}在裁判判定下\n战胜了{B_OPPONENT_MON1_NAME}！"),
    [STRINGID_LOSTTOOPPONENTBYREFEREE]              = COMPOUND_STRING("{B_PLAYER_MON1_NAME}在裁判判定下\n输给了{B_OPPONENT_MON1_NAME}！"),
    [STRINGID_TIEDOPPONENTBYREFEREE]                = COMPOUND_STRING("{B_PLAYER_MON1_NAME}在裁判判定下\n与{B_OPPONENT_MON1_NAME}战成了平手！"),
    [STRINGID_QUESTIONFORFEITMATCH]                 = COMPOUND_STRING("要放弃比赛资格，并退出比赛吗？"),
    [STRINGID_FORFEITEDMATCH]                       = COMPOUND_STRING("放弃了比赛资格。"),
    ...
    [STRINGID_PKMNSTOLEANDATEITEM]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n夺取并吃掉了{B_LAST_ITEM}！"),
    [STRINGID_TAILWINDBLEW]                         = COMPOUND_STRING("从{B_ATK_TEAM2}我方身后\n吹起了顺风！"),
    ...
    [STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("{B_DEF_TEAM2}方脚下\n散落着毒菱！"),
    ...
    [STRINGID_PROTECTEDTEAM]                        = COMPOUND_STRING("{B_CURRENT_MOVE}保护了{B_ATK_TEAM2}！"),
    ...
    [STRINGID_HURLEDINTOTHEAIR]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n浮在了空中！"),
    ...
    [STRINGID_PKMNACQUIREDSIMPLE]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}变成了单纯特性！"), //shouldn't directly use the name
    ...
    [STRINGID_RESTORETARGETSHEALTH]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的体力回复了！"),
    ...
    [STRINGID_TRANSFERHELDITEM]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}从{B_ATK_NAME_WITH_PREFIX2}那里\n收到了{B_LAST_ITEM}！"),
    [STRINGID_EMBARGOENDS]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n变得可以使用道具了！"),
    [STRINGID_ELECTROMAGNETISM]                     = COMPOUND_STRING("电磁力"),
    [STRINGID_BUFFERENDS]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_BUFF1}消失了！"),
    ...
    [STRINGID_TARGETABILITYSTATRAISE]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n使其{B_BUFF1}提高了！"),
    [STRINGID_TARGETSSTATWASMAXEDOUT]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n使其{B_BUFF1}被提高到了最大！"),
    [STRINGID_ATTACKERABILITYSTATRAISE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}\n使其{B_BUFF1}提高了！"),
    [STRINGID_POISONHEALHPUP]                       = COMPOUND_STRING("中毒使{B_ATK_NAME_WITH_PREFIX2}\n回复了一些体力！"), //don't think this message is displayed anymore
    ...
    [STRINGID_SOLARPOWERHPDROP]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n因{B_ATK_ABILITY}付出了代价！"), //don't think this message is displayed anymore
    ...
    [STRINGID_FOREWARNACTIVATES]                    = COMPOUND_STRING("{B_SCR_ACTIVE_ABILITY}使{B_SCR_NAME_WITH_PREFIX2}\n察觉到了{B_DEF_NAME_WITH_PREFIX2}的{B_BUFF1}！"),
    [STRINGID_ICEBODYHPGAIN]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}\n使其回复了一些体力！"), //don't think this message is displayed anymore
    ...
    [STRINGID_LASTABILITYRAISEDSTAT]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_LAST_ABILITY}\n使其{B_BUFF1}提高了！"),
    ...
    [STRINGID_CUSEDBODYDISABLED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_BUFF1}\n因{B_DEF_NAME_WITH_PREFIX2}的{B_DEF_ABILITY}被封住了！"),
    [STRINGID_ATTACKERACQUIREDABILITY]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的特性\n变为{B_ATK_ABILITY}！"),
    [STRINGID_TARGETABILITYSTATLOWER]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n使其{B_BUFF1}降低了！"),
    [STRINGID_TARGETSTATWONTGOHIGHER]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n{B_BUFF1}已经无法再提高了！"),
    [STRINGID_PKMNMOVEBOUNCEDABILITY]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_CURRENT_MOVE}\n被{B_DEF_NAME_WITH_PREFIX2}的{B_DEF_ABILITY}反弹了回去！"),
    [STRINGID_IMPOSTERTRANSFORM]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}使用{B_LAST_ABILITY}\n变成了{B_DEF_NAME_WITH_PREFIX2}！"),
    ...
    [STRINGID_HEALBLOCKPREVENTSUSAGE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的\n回复行为被封住了！\p"),
    ...
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}吹飞了毒菱！"),
    [STRINGID_PKMNBLEWAWAYSTICKYWEB]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}吹飞了黏黏网！"),
    [STRINGID_PKMNBLEWAWAYSTEALTHROCK]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}吹飞了隐形岩！"),
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_LAST_ITEM}和{B_ATK_TRAINER_NAME}的超级环起来反应！"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_NOEFFECTONTARGET]                     = COMPOUND_STRING("对{B_DEF_NAME_WITH_PREFIX2}\n没有效果！"),
    [STRINGID_BURSTINGFLAMESHIT]                    = COMPOUND_STRING("火花也溅射到了\n{B_SCR_NAME_WITH_PREFIX2}的身上！"),
    [STRINGID_BESTOWITEMGIVING]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}从\n{B_ATK_NAME_WITH_PREFIX2}那里\n收到了{B_LAST_ITEM}！"),
    [STRINGID_THIRDTYPEADDED]                       = COMPOUND_STRING("{B_BUFF1}\n增加了{B_DEF_NAME_WITH_PREFIX2}属性！"),
    ...
    [STRINGID_COVEREDINPOWDER]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n抛洒了粉尘！"),
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("火焰和宝可梦身上的粉尘起了反应，\n产生了爆炸！"),
    ...
    [STRINGID_SAFETYGOGGLESPROTECTED]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}因 {B_LAST_ITEM}\n而不会受到影响！"),
    ...
    [STRINGID_BERRYDMGREDUCES]                      = COMPOUND_STRING("{B_LAST_ITEM}减轻了\n对{B_DEF_NAME_WITH_PREFIX2}造成的伤害！"),
    [STRINGID_TARGETATEITEM]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}吃掉了{B_LAST_ITEM}！"),
    [STRINGID_AIRBALLOONFLOAT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}\n靠着气球浮在了空中！"),
    ...
    [STRINGID_BUGBITE]                              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n夺取并吃掉了{B_LAST_ITEM}！"),
    [STRINGID_ILLUSIONWOREOFF]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}造成的\n幻觉被解除了！"),
    ...
    [STRINGID_HEALERCURE]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_LAST_ABILITY}\n治愈了{B_SCR_NAME_WITH_PREFIX2}的异常状态！"),
    [STRINGID_SCRIPTINGABILITYSTATRAISE]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n使其{B_BUFF1}提高了！"),
    [STRINGID_RECEIVERABILITYTAKEOVER]              = COMPOUND_STRING("继承了{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}！"),
    ...
    [STRINGID_CLEARAMULETWONTLOWERSTATS]            = COMPOUND_STRING("因为{B_SCR_NAME_WITH_PREFIX2}持有的{B_LAST_ITEM}，\n其能力不会被降低！"),
    ...
    [STRINGID_PRESSUREENTERS]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的身上\n感到了一种压迫感！"),
    ...
    [STRINGID_SCREENCLEANERENTERS]                  = COMPOUND_STRING("场上所有的屏障都被清除了！"),
    [STRINGID_FETCHEDPOKEBALL]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}找到了1个{B_LAST_ITEM}！"),
    [STRINGID_BATTLERABILITYRAISEDSTAT]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n使其{B_BUFF1}提高了！"),
    [STRINGID_ASANDSTORMKICKEDUP]                   = COMPOUND_STRING("开始刮沙暴了！"),
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("双方宝可梦将在3回合内倒下！"),  //don't think this message is displayed anymore
    [STRINGID_ABILITYRAISEDSTATDRASTICALLY]         = COMPOUND_STRING("{B_DEF_ABILITY}\n大幅提高了{B_DEF_NAME_WITH_PREFIX2}的{B_BUFF1}！"),
    ...
    [STRINGID_STICKYBARBTRANSFER]                   = COMPOUND_STRING("{B_LAST_ITEM}\n依附到了{B_ATK_NAME_WITH_PREFIX2}身上！"),
    ...
    [STRINGID_BUTPOKEMONCANTUSETHEMOVE]             = COMPOUND_STRING("但是，{B_ATK_NAME_WITH_PREFIX2}无法使用！"),
    ...
    [STRINGID_ABILITYALLOWSONLYMOVE]                = COMPOUND_STRING("因为{B_ATK_ABILITY}\n只能使出{B_CURRENT_MOVE}！\p"),
    ...
    [STRINGID_PASTELVEILENTERS]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}中的毒\n彻底清除了！"),
    ...
    [STRINGID_CANTESCAPEDUETOUSEDMOVE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n受到背水一战的效果影响，无法逃走了！"),
    ...
    [STRINGID_CANTESCAPEBECAUSEOFCURRENTMOVE]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}受到蛸固的效果影响，\n变得无法逃走了！"),
    ...
    [STRINGID_PLAYERLOSTTOENEMYTRAINER]             = COMPOUND_STRING("手上没有可以战斗的宝可梦！\p被{B_TRAINER1_NAME_WITH_CLASS}\n打败了！{PAUSE_UNTIL_PRESS}"),
    [STRINGID_PLAYERPAIDPRIZEMONEY]                 = COMPOUND_STRING("支付了¥{B_BUFF1}\n作为奖金…\p眼前变得一片漆黑！{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ZMOVERESETSSTATS]                     = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}恢复了降低的能力！"),
    [STRINGID_ZMOVEALLSTATSUP]                      = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}的能力提高了！"),
    [STRINGID_ZMOVEZBOOSTCRIT]                      = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}变得容易击中要害了！"),
    [STRINGID_ZMOVERESTOREHP]                       = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}回复了体力！"),
    [STRINGID_ZMOVESTATUP]                          = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}的能力提高了！"),
    [STRINGID_ZMOVEHPTRAP]                          = COMPOUND_STRING("因为Z力量，\n{B_SCR_NAME_WITH_PREFIX}的体力回复了！"),
    ...
    [STRINGID_TARGETTOUGHEDITOUT]                   = COMPOUND_STRING("为了不让你伤心，\n{B_DEF_NAME_WITH_PREFIX}撑住了！"),
    ...
    [STRINGID_STATWASHEIGHTENED]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的\n{B_BUFF1}升高了！"),
    [STRINGID_ELECTRICTERRAINACTIVATEDABILITY]      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX2}通过\n电气场地发动了夸克充能！"),
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}令周围的宝可梦的{B_BUFF1}减弱了！\p"),
    [STRINGID_ATTACKERGAINEDSTRENGTHFROMTHEFALLEN]  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}从\n被打倒的同伴身上得到力量了！"),
    [STRINGID_PKMNSABILITYPREVENTSABILITY]          = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n阻止了{B_DEF_NAME_WITH_PREFIX2}的{B_DEF_ABILITY}生效！"), //not in gen 5+, ability popup
    [STRINGID_PREPARESHELLTRAP]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n设置了陷阱甲壳！"),
    ...
    [STRINGID_TOXICSPIKESDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("{B_ATK_TEAM2}方脚下的\n毒菱消失不见了！"),
    ...
    [STRINGID_ITEMCUREDSPECIESSTATUS]               = COMPOUND_STRING("{B_BUFF1}的\n状态恢复了！"),
    ...
    [STRINGID_PKMNSITEMHEALEDFROSTBITE]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n治愈了冻伤！"),
    [STRINGID_ATTACKERHEALEDITSFROSTBITE]           = COMPOUND_STRING("为了不让你担心，\n{B_ATK_NAME_WITH_PREFIX}靠毅力治愈了冻伤！"),
    ...
    [STRINGID_PKMNFROSTBITEHEALEDBY]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}的{B_CURRENT_MOVE}\n治愈了冻伤！"),
    [STRINGID_MIRRORHERBCOPIED]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}使用模仿香草\n模仿了对手的能力变化！"),
    [STRINGID_STARTEDSNOW]                          = COMPOUND_STRING("开始下雪了！"),
    [STRINGID_SNOWCONTINUES]                        = COMPOUND_STRING("雪持续在下。"), //not in gen 5+ (lol)
    ...
    [STRINGID_CURRENTMOVECANTSELECT]                = COMPOUND_STRING("无法使用{B_BUFF1}！\p"),
    ...
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_DEF_TEAM1}\n被困在鞭子的猛击中！"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n被暴露在超极巨灰飞鞭灭的猛击下，疼痛难忍！"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1}\n被困在水流之中！"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n被吞没在超极巨水炮轰灭的水流里，痛苦难耐！"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1}\n被困在火焰之中！"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n被超极巨地狱灭焰的火焰包围，酷热难耐！"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1}\n被困在岩石之中！"),
    [STRINGID_PKMNHURTBYROCKSTHROWN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n被困在超极巨炎石喷发的岩石之中，疼痛难忍！"),
    ...
    [STRINGID_WAITINGFORPARTNERSMOVE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}正在等待\n{B_ATK_PARTNER_NAME}…{PAUSE 16}"),
    [STRINGID_SEAOFFIREENVELOPEDSIDE]               = COMPOUND_STRING("{B_DEF_TEAM2}周围被\n火海包围了！"),
    [STRINGID_HURTBYTHESEAOFFIRE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n受到了火海的伤害！"),
    [STRINGID_THESEAOFFIREDISAPPEARED]              = COMPOUND_STRING("{B_ATK_TEAM2}周围的火海\n消失不见了！"),
    [STRINGID_SWAMPENVELOPEDSIDE]                   = COMPOUND_STRING("{B_DEF_TEAM2}周围\n延伸出了湿地！"),
    [STRINGID_THESWAMPDISAPPEARED]                  = COMPOUND_STRING("{B_ATK_TEAM2}周围的湿地\n消失不见了！"),
    [STRINGID_PKMNTELLCHILLINGRECEPTIONJOKE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n说出了冷笑话！"),
    [STRINGID_HOSPITALITYRESTORATION]               = COMPOUND_STRING("{B_ATK_PARTNER_NAME}喝光了\n{B_ATK_NAME_WITH_PREFIX2}泡的茶！"),
    [STRINGID_ELECTROSHOTCHARGING]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n吸收了电力！"),
    [STRINGID_ITEMWASUSEDUP]                        = COMPOUND_STRING("The {B_LAST_ITEM}已完成使命，\n消失了…"),
    [STRINGID_ATTACKERLOSTITSTYPE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n失去了{B_BUFF1}属性！"),
    [STRINGID_SHEDITSTAIL]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}断掉尾巴\n并将其作为替身了！"),
    [STRINGID_CLOAKEDINAHARSHLIGHT]                 = COMPOUND_STRING("强光包围了\n{B_ATK_NAME_WITH_PREFIX}！"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("凭空制造出了会让持有道具的\n效果消失的空间！"),
    [STRINGID_BIZARREAREACREATED]                   = COMPOUND_STRING("凭空制造出了互换\n防御和特防的空间！"),
    [STRINGID_TIDYINGUPCOMPLETE]                    = COMPOUND_STRING("大扫除完毕！"),
    [STRINGID_PKMNTERASTALLIZEDINTO]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}通过太晶化\n变成了{B_BUFF1}属性！"),
    [STRINGID_BOOSTERENERGYACTIVATES]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}通过\n{B_LAST_ITEM}发动了{B_SCR_ACTIVE_ABILITY}！"),
    ...
    [STRINGID_POKEFLUTECATCHY]                      = COMPOUND_STRING("{B_PLAYER_NAME}吹响了{B_LAST_ITEM}。\p那是一首朗朗上口的曲子！"),
...
const u8 gText_WhatWillWallyDo[] = _("小光\n该怎么办？");
const u8 gText_LinkStandby[] = _("{PAUSE 16}等待连接……");
...
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}要忘记哪个招式？");
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}是\n否");
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}交换\n哪一个？");
...
const u8 gText_BattleWallyName[] = _("小光");
const u8 gText_Win[] = _("{HIGHLIGHT TRANSPARENT}获胜");
const u8 gText_Loss[] = _("{HIGHLIGHT TRANSPARENT}输了");
...
const u8 gText_Judgment[] = _("{B_BUFF1}{CLEAR 13}判定t{CLEAR 13}{B_BUFF2}");
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS}派出了\n{B_OPPONENT_MON1_NAME}！\p{B_TRAINER2_NAME_WITH_CLASS}派出了\n{B_OPPONENT_MON2_NAME}！");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_NAME_WITH_CLASS}派出了\n{B_BUFF1}！");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS} 和\n{B_TRAINER2_NAME_WITH_CLASS}\n前来挑战了！\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_NAME_WITH_CLASS}派出了{B_PLAYER_MON2_NAME}！\n上吧！{B_PLAYER_MON1_NAME}！");
...
{
    [B_MSG_REF_NOTHING_IS_DECIDED] = COMPOUND_STRING("裁判：如果3回合内没有结果，\n则由裁判进行评分决定胜负！"),
    [B_MSG_REF_THATS_IT]           = COMPOUND_STRING("裁判：好了！\n现在我们将进行评分决定胜者！"),
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("裁判：评分类别1，心！展现出最强毅力的宝可梦！\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("裁判：评分类别2，技！使用招式最棒的宝可梦！\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("裁判：评分类别3，体！具有最强生命力的宝可梦！\p"),
    [B_MSG_REF_PLAYER_WON]         = COMPOUND_STRING("裁判：评分结果：{B_BUFF1} 对 {B_BUFF2}！\n胜者是{B_PLAYER_NAME}的{B_PLAYER_MON1_NAME}！\p"),
    [B_MSG_REF_OPPONENT_WON]       = COMPOUND_STRING("裁判：评分结果：{B_BUFF1} 对 {B_BUFF2}！\n胜者是{B_TRAINER1_NAME}的{B_OPPONENT_MON1_NAME}！\p"),
    [B_MSG_REF_DRAW]               = COMPOUND_STRING("裁判：评分结果： 3 对 3！\n双方平局！\p"),
...
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("与{B_TRAINER1_NAME_WITH_CLASS}\n打成了平局！");
const u8 gText_RecordBattleToPass[] = _("你想在你的开拓区通行证上记录这场战斗吗？");
const u8 gText_BattleRecordedOnPass[] = _("{B_PLAYER_NAME}的战斗结果被记录在开拓区通行证上。");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{B_LINK_OPPONENT1_NAME}\n前来挑战了！\p");
static const u8 sText_TwoLinkTrainersWantToBattlePause[] = _("{B_LINK_OPPONENT1_NAME} 和\n{B_LINK_OPPONENT2_NAME}\n前来挑战了！\p");
