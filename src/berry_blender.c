...
static const u8 sText_BerryBlenderStart[] = _("打开树果混合器。\p请选择一个树果放入树果混合器\p");
static const u8 sText_NewParagraph[] = _("\p");
static const u8 sText_WasMade[] = _(" 做出来了！");
...
static const u8 sText_CommunicationStandby[] = _("通讯连接中……");
static const u8 sText_WouldLikeToBlendAnotherBerry[] = _("你想混合另一个树果吗？");
static const u8 sText_RunOutOfBerriesForBlending[] = _("你已经没有树果来进行混合了。\p");
static const u8 sText_YourPokeblockCaseIsFull[] = _("你的{POKEBLOCK}盒已经满了。\p");
static const u8 sText_HasNoBerriesToPut[] = _(" 没有树果可以放进树果混合器了。");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] = _("的{POKEBLOCK}盒已经满了。\p");
static const u8 sText_BlendingResults[] = _("混合结果");
static const u8 sText_SpaceBerry[] = _(" 树果");
static const u8 sText_Time[] = _("时间:");
static const u8 sText_Min[] = _(" 分钟. ");
...
static const u8 sText_Ranking[] = _("排行");
static const u8 sText_TheLevelIs[] = _("等级是 ");
static const u8 sText_TheFeelIs[] = _("，口味是 ");
