...
const u8 gEasyChatWord_Kid[] = _("孩子");
const u8 gEasyChatWord_Children[] = _("孩子们");
const u8 gEasyChatWord_Mr[] = _("先生");
const u8 gEasyChatWord_Mrs[] = _("夫人");
const u8 gEasyChatWord_Myself[] = _("我自己");
const u8 gEasyChatWord_IWas[] = _("我是");
const u8 gEasyChatWord_ToMe[] = _("对我来说");
const u8 gEasyChatWord_My[] = _("我的");
const u8 gEasyChatWord_IAm[] = _("我是");
const u8 gEasyChatWord_Ive[] = _("我已经");
const u8 gEasyChatWord_Who[] = _("谁");
const u8 gEasyChatWord_Someone[] = _("某人");
const u8 gEasyChatWord_WhoWas[] = _("谁是");
const u8 gEasyChatWord_ToWhom[] = _("对谁");
const u8 gEasyChatWord_Whose[] = _("谁的");
const u8 gEasyChatWord_WhoIs[] = _("谁是");
const u8 gEasyChatWord_Its[] = _("它的");
const u8 gEasyChatWord_Lady[] = _("女士");
const u8 gEasyChatWord_Friend[] = _("朋友");
const u8 gEasyChatWord_Ally[] = _("盟友");
const u8 gEasyChatWord_Person[] = _("人");
const u8 gEasyChatWord_Dude[] = _("伙计");
const u8 gEasyChatWord_They[] = _("他们");
const u8 gEasyChatWord_TheyWere[] = _("他们是");
