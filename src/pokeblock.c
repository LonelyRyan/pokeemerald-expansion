...
const u8 *const gPokeblockNames[] =
{
    ...
    [PBLOCK_CLR_RED]       = COMPOUND_STRING("红色{POKEBLOCK}"),
    [PBLOCK_CLR_BLUE]      = COMPOUND_STRING("蓝色{POKEBLOCK}"),
    [PBLOCK_CLR_PINK]      = COMPOUND_STRING("粉色{POKEBLOCK}"),
    [PBLOCK_CLR_GREEN]     = COMPOUND_STRING("绿色{POKEBLOCK}"),
    [PBLOCK_CLR_YELLOW]    = COMPOUND_STRING("黄色{POKEBLOCK}"),
    [PBLOCK_CLR_PURPLE]    = COMPOUND_STRING("紫色{POKEBLOCK}"),
    [PBLOCK_CLR_INDIGO]    = COMPOUND_STRING("靛蓝色{POKEBLOCK}"),
    [PBLOCK_CLR_BROWN]     = COMPOUND_STRING("棕色{POKEBLOCK}"),
    [PBLOCK_CLR_LITE_BLUE] = COMPOUND_STRING("浅蓝色{POKEBLOCK}"),
    [PBLOCK_CLR_OLIVE]     = COMPOUND_STRING("橄榄色{POKEBLOCK}"),
    [PBLOCK_CLR_GRAY]      = COMPOUND_STRING("灰色{POKEBLOCK}"),
    [PBLOCK_CLR_BLACK]     = COMPOUND_STRING("黑色{POKEBLOCK}"),
    [PBLOCK_CLR_WHITE]     = COMPOUND_STRING("白色{POKEBLOCK}"),
    [PBLOCK_CLR_GOLD]      = COMPOUND_STRING("金色{POKEBLOCK}")
};
...
static void DrawPokeblockMenuTitleText(void)
{
    ...
    PrintOnPokeblockWindow(WIN_SPICY,  COMPOUND_STRING("辣"),  0);
    PrintOnPokeblockWindow(WIN_DRY,    COMPOUND_STRING("涩"),    0);
    PrintOnPokeblockWindow(WIN_SWEET,  COMPOUND_STRING("甜"),  0);
    PrintOnPokeblockWindow(WIN_BITTER, COMPOUND_STRING("苦"), 0);
    PrintOnPokeblockWindow(WIN_SOUR,   COMPOUND_STRING("酸"),   0);
