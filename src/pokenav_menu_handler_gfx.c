...
static const u8 *const sPageDescriptions[] =
{
    ...
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("详细地查看宝可梦."),
    [POKENAV_MENUITEM_MATCH_CALL]              = COMPOUND_STRING("呼叫已登记的训练师."),
    [POKENAV_MENUITEM_RIBBONS]                 = COMPOUND_STRING("检查已得到的缎带."),
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("放好领航员."),
    [POKENAV_MENUITEM_CONDITION_PARTY]         = COMPOUND_STRING("详细地查看队伍内的宝可梦."),
    [POKENAV_MENUITEM_CONDITION_SEARCH]        = COMPOUND_STRING("详细地查看所有宝可梦."),
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("返回领航员主菜单."),
    ...
    [POKENAV_MENUITEM_CONDITION_SEARCH_CANCEL] = COMPOUND_STRING("返回领航员主菜单.")
};
