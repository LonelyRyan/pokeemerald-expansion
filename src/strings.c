...
const u8 gText_FreshWaterAndPrice[] = _("美味的水{CLEAR_TO 0x48}200元");
const u8 gText_SodaPopAndPrice[] = _("塞可汽水{CLEAR_TO 0x48}300元");
const u8 gText_LemonadeAndPrice[] = _("调味乳{CLEAR_TO 0x48}350元");
...
const u8 gText_EnergyPowder50[] = _("力之粉{CLEAR_TO 114}{FONT_SMALL} 50");
const u8 gText_EnergyRoot80[] = _("力之根{CLEAR_TO 114}{FONT_SMALL} 80");
const u8 gText_HealPowder50[] = _("万能之粉{CLEAR_TO 114}{FONT_SMALL} 50");
const u8 gText_RevivalHerb300[] = _("复活之草{CLEAR_TO 108}{FONT_SMALL} 300");
const u8 gText_Protein1000[] = _("蛋白药剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
const u8 gText_Iron1000[] = _("补铁药剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
const u8 gText_Carbos1000[] = _("补碳药剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
const u8 gText_Calcium1000[] = _("补钙药剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
const u8 gText_Zinc1000[] = _("补锌药剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
const u8 gText_HPUp1000[] = _("HP提升剂{CLEAR_TO 99}{FONT_SMALL} 1,000");
...
#else
const u8 gText_PkmnFainted_FldPsn[] = _("{STR_VAR_1}在中毒中存活\n毒素渐渐消失了\p");
#endif
...
const u8 gText_PkmnForSwap[] = _("要换{PKMN}");
...
const u8 gText_LightBulb[] = _("电灯");
const u8 gText_MicrowaveOven[] = _("微波炉");
const u8 gText_WashingMachine[] = _("洗衣机");
const u8 gText_Refrigerator[] = _("电冰箱");
const u8 gText_ElectricFan[] = _("电风扇");
const u8 gText_LawnMower[] = _("除草机");
const u8 gText_ChangeForm[] = _("改变形态");
const u8 gText_ChangeAbility[] = _("改变特性");
...
const u8 gText_ExpShareOn[] = _("经验分享已经打开{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("经验分享已经关闭{PAUSE_UNTIL_PRESS}");
const u8 gText_BasePointsResetToZero[] = _("{STR_VAR_1}的基础分数\n被重置为零{PAUSE_UNTIL_PRESS}");
const u8 gText_Fertilize[] = _("施肥");
const u8 gText_PlantBerry[] = _("种树果");
const u8 gText_AM[] = _("AM");
const u8 gText_PM[] = _("PM");
const u8 gText_MenuCure[] = _("治疗");
